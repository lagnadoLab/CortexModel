...
pc_all = np.loadtxt(r'QA_Avg_Sess1_PC_NoLoco.txt')
# PC_average_standard_error
pc_all_err = np.loadtxt(r'QA_SEM_Sess1_PC_NoLoco.txt')

# Experimental time calculation
t_exp_1 = exp_time(start=0.0, step=dt, count=len(pc_all))

# PV_average (whole population)
pv = np.loadtxt(r'QA_Avg_Sess1_PV_NoLoco.txt')
# PV_average_standard_error
pv_err = np.loadtxt(r'QA_SEM_Sess1_PV_NoLoco.txt')
...
sst = np.loadtxt(r'QA_Avg_Sess1_SST_NoLoco.txt')
# SST_average_standard_error
sst_err = np.loadtxt(r'QA_SEM_Sess1_SST_NoLoco.txt')
...
vip = np.loadtxt(r'QA_Avg_Sess1_VIPPos_NoLoco.txt')
# VIP_average_standard_error
vip_err = np.loadtxt(r'QA_SEM_Sess1_VIP_NoLoco.txt')
...
input_file = "sobol_samples_reduced.csv"
